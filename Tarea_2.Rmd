...
```{r}
df_original <- read_csv("data/faces.csv")
```
...
```
```{r}
ggsave("images/grafico_tiempo.png", width = 8, height = 5)
```
...
```{r}
ggsave("images/grafico_barras.png", width = 8, height = 5)
```

...
La base de datos utilizada `faces.csv` proviene del proyecto "**The Pudding**" un medio de periodismo visual que combina narrativas, **datos y diseño interactivo para explorar fenómenos culturales contemporáneos**. Este medio contenía esta base de datos en GitHub propio.
...
|--------|------------|---------|--------|------------|--------|
| 0.2127 | 0.6058     | 0.6729  | 0.6595 | 0.7266     | 0.8824 |

-   De este modo, según esta clasificación las categorías resultantes fueron las siguientes:

| Categoría   | Rango         | Descripción                              |
|-------------|---------------|------------------------------------------|
| Tono oscuro | 0.2127-0.6058 | Hasta el primer cuartil (Q1)             |
| Tono medio  | 0.6059-0.7266 | Entre el primer y tercer cuartil (Q1-Q3) |
| tono claro  | 0.7267-0.8824 | A partir del tercer cuartil (Q3)         |
...
| Modelo          | Luminosidad |
|-----------------|-------------|
| Lupita Nyongo   | 0.2127451   |
| Lupita Nyongo   | 0.2574230   |
| Michelle Obama  | 0.3541176   |
| Serena Williams | 0.3750000   |
| Lupita Nyongo   | 0.4166667   |
| Lupita Nyongo   | 0.4205882   |
| Imaan Hammam    | 0.4254902   |
| Serena Williams | 0.4305147   |
| Beyonce         | 0.4338936   |
| Halle Berry     | 0.4424837   |
...
| Modelo            | Luminosidad |
|-------------------|-------------|
| Anne Hathaway     | 0.8823529   |
| Jessica Chastain  | 0.8612745   |
| Claire Foy        | 0.8582268   |
| Amy Adams         | 0.8573529   |
| Natalia Vodianova | 0.8555556   |
| Lady Gaga         | 0.8357298   |
| Daria Werbowy     | 0.8348584   |
| Anne Hathaway     | 0.8339461   |
| Kendall Jenner    | 0.8243550   |
| Keira Knightley   | 0.8225490   |
...
|  Año | Tono de piel | Cantidad de modelos |
|-----:|--------------|--------------------:|
| 2000 | Oscuro       |                   2 |
| 2000 | Medio        |                  12 |
| 2000 | Claro        |                   2 |
...
-   En varios años, la **proporción de pieles oscuras es inferior al 10%**. Para algunos periodos, Vogue no tiene registros de participación de mujeres de pieles oscuras en sus portadas.
...
-   Otra limitante importante es que el análisis porcentual no considera el número total de portadas publicadas por año. Esto significa que un mismo porcentaje puede representar realidades muy distintas: si un año tuvo solo dos portadas y una de ellas correspondió a un tono oscuro, el gráfico mostrará 50%, mientras que otro año con cuatro portadas podría registrar también una portada de tono oscuro, pero reflejar solo un 25%.

    -   Sin tomar en cuenta el volumen total, **los porcentajes pueden dar una impresión distorsionada de la evolución real de la representación**. Incluir esta información permitiría diferenciar entre variaciones reales en diversidad y efectos producidos simplemente por el tamaño desigual de la muestra anual.
